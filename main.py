...
def make_video():
    ...
    ffmpeg_command = [
        ...
        f'[with_title]drawtext=fontfile=\'{font_path}\':text=\'{formatted_desc}\':fontcolor=white@0.85:fontsize=32:line_spacing=4:text_align=center:x=(w-text_w)/2:y=1400[final]',
        '-map', '[final]',
        '-map', '1:a',
        '-shortest',
        '-c:v', 'libx264',
